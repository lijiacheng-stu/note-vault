...
class DataLoader(Generic[_T_co]):
    ...
    Args:
        ...
        multiprocessing_context (str or multiprocessing.context.BaseContext, optional): If
            ``None``, the default
            `multiprocessing context <[https://docs.python.org/3/library/multiprocessing.html#contexts-and-start-methods>`_](https://docs.python.org/3/library/multiprocessing.html#contexts-and-start-methods%3E%60_) # noqa: D401
...
File:           ~/Documents/custom/development/ml/.venv/lib/python3.12/site-packages/torch/utils/data/dataloader.py
Type:           type
Subclasses: